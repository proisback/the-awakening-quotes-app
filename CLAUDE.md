...
- `index.html` — three screens (reader feed, saved, settings) + bottom tab bar, a note `<dialog>`, a share `<dialog>` (`#shareSheet`: Save as image / Share as text), and a `#toast` element.
